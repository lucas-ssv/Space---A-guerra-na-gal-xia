...
public class dominador : MonoBehaviour {
	...
	void tomarDano (int danoTomado) {
		...
		healthEscudo.fillAmount = vida / 100f; // Barra de escudo

		healthBar.fillAmount = Hp / 100f; // Barra de vida será a quantidade de Hp do inimigo
